				...
				<div className="flex justify-between text-center md:mx-20 md:pt-32 pt-28 ">
					...
					<div className="flex flex-col md:ml-20 mx-10 mt-10">
						<h1 className="font-bold text-7xl text-left mb-5">
							Say Hello to <span className="text-black">Tecblic</span>
						</h1>
						...
						<a
							href="#"
							className="font-semibold text-white md:mt-10 mt-5 pt-5 bg-black rounded-md w-60 h-16 text-lg hover:bg-black "
						>
							See My Portfolio !
						</a>
					</div>
